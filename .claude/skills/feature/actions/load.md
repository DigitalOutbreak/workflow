...
1. Check $ARGUMENTS (after "load"):
   - If it looks like a filename (single word, no spaces): Look for `docs/context/features/{name}.md`, `docs/context/features/{name}-spec.md`, or `docs/context/fixes/{name}.md`
